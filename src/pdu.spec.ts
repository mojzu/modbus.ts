...
import { FunctionCode, ModbusPduClient } from "./pdu";
...
describe("Modbus PDU", () => {
  ...
  it("Read Coils", () => {
    ...
    expect(request[0]).toEqual(FunctionCode.ReadCoils);
  ...
  it("Read Discrete Inputs", () => {
    ...
    expect(request[0]).toEqual(FunctionCode.ReadDiscreteInputs);
  ...
  it("Read Holding Registers", () => {
    ...
    expect(request[0]).toEqual(FunctionCode.ReadHoldingRegisters);
  ...
  it("Read Input Registers", () => {
    ...
    expect(request[0]).toEqual(FunctionCode.ReadInputRegisters);
  ...
  it("Write Single Coil", () => {
    ...
    expect(request[0]).toEqual(FunctionCode.WriteSingleCoil);
  ...
  it("Write Single Register", () => {
    ...
    expect(request[0]).toEqual(FunctionCode.WriteSingleRegister);
  ...
  it("Write Multiple Registers", () => {
    ...
    expect(request[0]).toEqual(FunctionCode.WriteMultipleRegisters);
